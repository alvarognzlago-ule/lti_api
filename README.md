...
[![LTI](https://img.shields.io/badge/LTI-1.3-orange)](https://www.imsglobal.org/spec/lti/v1p3/)## 📋 Tabla de Contenidos
...
## 🎯 ¿Qué es esto?3. [Requisitos del Sistema](#-requisitos-del-sistema)
...
### ✨ Características Principales7. [Arquitectura del Sistema](#-arquitectura-del-sistema)

8. [Estructura del Proyecto](#-estructura-del-proyecto)

**Para Estudiantes:**9. [API y Endpoints](#-api-y-endpoints)

- 📤 Subida de archivos (PDF, DOCX, ZIP, etc.) hasta 10MB10. [Sistema de Persistencia](#-sistema-de-persistencia)

- 📝 Cuestionario post-entrega obligatorio (5 preguntas metacognitivas)11. [Scripts Utilitarios](#-scripts-utilitarios)

- ✏️ Edición y reemplazo de entregas antes de la fecha límite12. [Resolución de Problemas](#-resolución-de-problemas)

- 📊 Visualización de calificaciones y retroalimentación del profesor13. [Seguridad](#-seguridad)

- 💬 Comentarios opcionales sobre la entrega14. [Migración a Producción](#-migración-a-producción)



**Para Profesores:**---

- 📋 Panel con lista de todas las entregas y estadísticas

- 👁️ Vista detallada de cada entrega (archivo + cuestionario)## 🎯 ¿Qué es esto?

- ⬇️ Descarga de archivos entregados

- ⭐ Sistema de calificación integrado (0-10)Una **herramienta externa LTI 1.3** para Moodle que permite gestionar entregas de tareas de forma completa e integrada.

- ✏️ Edición de calificaciones ya asignadas

- 📝 Retroalimentación personalizada para cada estudiante### Funcionalidad Principal
...
## 🚀 Inicio Rápido- Acceder a detalles completos de cada entrega

- Descargar archivos entregados

### Prerrequisitos- Ver estadísticas y respuestas del cuestionario



- **Node.js** v14 o superior**Integración:**
...
### Instalación- Cuestionario metacognitivo de 5 preguntas
...
git clone https://github.com/alvarongzlgo-ule/lti_api.git## ✨ Características Principales
...
# 3. Generar claves JWKS  - Límite: 10MB por archivo

node generate-keys.js- ✅ **Cuestionario post-entrega** obligatorio con 5 preguntas:

  - ⏱️ Tiempo dedicado a la tarea

# 4. Configurar variables de entorno  - 📊 Nivel de dificultad percibido
