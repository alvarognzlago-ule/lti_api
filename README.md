...
10. [Sistema de Persistencia](#-sistema-de-persistencia)
11. [Scripts Utilitarios](#-scripts-utilitarios)
12. [Resolución de Problemas](#-resolución-de-problemas)
13. [Seguridad](#-seguridad)
14. [Migración a Producción](#-migración-a-producción)

---

## 🎯 ¿Qué es esto?

Una **herramienta externa LTI 1.3** para Moodle que permite gestionar entregas de tareas de forma completa e integrada.

### Funcionalidad Principal

**Para Estudiantes:**
- Subir archivos de tareas con validación automática
- Completar cuestionario post-entrega obligatorio
- Editar y reemplazar entregas existentes
- Ver historial de entregas propias

**Para Profesores:**
- Ver lista completa de todas las entregas
- Acceder a detalles completos de cada entrega
- Descargar archivos entregados
- Ver estadísticas y respuestas del cuestionario

**Integración:**
- Autenticación segura mediante LTI 1.3 + OIDC
- Sin necesidad de credenciales adicionales
- Roles automáticos desde Moodle
- Cuestionario metacognitivo de 5 preguntas
...
- ✅ **Subida de archivos** con validación de tipo y tamaño
  - Formatos: PDF, DOC, DOCX, ZIP, RAR, TXT, JPG, PNG
  - Límite: 10MB por archivo
- ✅ **Cuestionario post-entrega** obligatorio con 5 preguntas:
  - ⏱️ Tiempo dedicado a la tarea
  - 📊 Nivel de dificultad percibido
  - 📚 Recursos utilizados (múltiple selección)
  - 💭 Principales desafíos encontrados
  - 🎓 Aprendizajes clave obtenidos
- ✅ **Comentarios opcionales** sobre la entrega
- ✅ **Visualización de entregas previas** con toda la información
...
- ✅ **Confirmación visual** al completar la entrega

### 👨‍🏫 Vista Profesor

- ✅ **Panel de estadísticas** en tiempo real:
  - Total de entregas recibidas
  - Entregas completas (con cuestionario)
  - Entregas pendientes de cuestionario
- ✅ **Lista de entregas** con información resumida:
  - Nombre del estudiante
  - Archivo entregado y tamaño
  - Estado del cuestionario
  - **Calificación asignada** (si existe)
  - Fecha y hora de entrega
- ✅ **Vista detallada individual** de cada entrega:
  - Información completa del estudiante
  - Archivo con opción de descarga
...
- ✅ **Sistema de calificación integrado**:
  ...
  - Registro automático del nombre del profesor
...
- ✅ **Protección contra escrituras simultáneas** con flag de bloqueo
- ✅ **Validación de integridad** al cargar y guardar:
...
- ✅ **Gestión de archivos** en directorio `uploads/`

### 🔐 Seguridad y Autenticación

- ✅ **LTI 1.3** con flujo OIDC completo
...
- **Node.js**: v14.0 o superior (recomendado v18+)
- **npm**: v6.0 o superior
- **Moodle**: v3.9 o superior (recomendado v4.0+)
- **Sistema Operativo**: Windows, Linux o macOS

### Para Desarrollo Local

- **ngrok** o túnel similar para exponer servidor local
...
git clone <tu-repositorio> c:\API
cd c:\API
```
...
- `express@5.1.0` - Framework de servidor web
- `express-session@1.18.2` - Gestión de sesiones
- `dotenv@17.2.3` - Variables de entorno
- `jsonwebtoken@9.0.2` - Verificación y firma JWT
- `node-jose@2.2.0` - Criptografía JWKS
- `axios@1.13.0` - Cliente HTTP
- `multer@2.0.2` - Gestión de subida de archivos
- `node-fetch@2.7.0` - Cliente fetch para Node.js
...
📦 Cargadas 0 entregas desde disco
📁 Directorio de uploads verificado
🚀 Servidor LTI escuchando en puerto 3000
🔗 Base URL configurada: https://tu-subdominio.ngrok-free.app
```
...
Copia la URL HTTPS que proporciona ngrok (ej: `https://abc123.ngrok-free.app`) y actualízala en el archivo `.env`
...
3. Completa:
   - **Nombre**: "Sistema de Entregas API"
   - **Nombre corto**: "entregas_api"
   - **Habilitado**: ✅ Sí
4. Guarda

#### Paso 3: Agregar funciones al servicio

1. Haz clic en **"Agregar funciones"** en el servicio que acabas de crear
2. Busca y agrega estas funciones:
